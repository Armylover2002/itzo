...
export const adminApi = {
  ...
  refundReturnLeg: (sellerReturnId, data) => axiosInstance.post(`/quick-commerce/returns/admin/legs/${sellerReturnId}/refund`, data),
  ...
  processRefund: (orderId, data) => axiosInstance.post(`/quick-commerce/admin/orders/${orderId}/refund`, data),
};
