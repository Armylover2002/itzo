        ...
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
              <UserPlus className="w-5 h-5 text-[#550fa8]" />
              Assign Delivery Boy
            </h3>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 border border-gray-200 rounded-xl py-2.5 pl-10 pr-4 text-sm focus:outline-none focus:ring-2 focus:ring-[#6412c6]/20 focus:border-[#9359d7]"
              autoFocus
            />
          </div>
        </div>
            ...
            <div className="space-y-2">
              {partners.map(partner => {
                ...
                return (
                  <div
                    key={partner._id}
                    className="flex items-center gap-3 p-3 rounded-xl border border-gray-100 hover:border-[#d8c4f1] hover:bg-[#f7f3fc]/30 transition-all group"
                  >
                    {/* Avatar */}
                    <div className="relative flex-shrink-0">
                      {partner.profilePhoto ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#f0e7f9] to-[#d8c4f1] flex items-center justify-center">
                          <span className="text-sm font-bold text-[#550fa8]">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#550fa8] hover:bg-[#460d8b] text-white text-xs font-bold rounded-lg transition-colors disabled:opacity-50 flex items-center gap-1"
                      >
                        {isAssigning ? (
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div>
          <span className="px-4 py-2 rounded-full text-sm font-bold bg-[#f0e7f9] text-[#370a6d] uppercase">
            ...
            {isReviewPending && (
              <div className="mt-6 flex justify-end">
                <button 
                  ...
                  disabled={submitting}
                  className="bg-[#550fa8] hover:bg-[#460d8b] text-white font-bold py-2 px-6 rounded-lg shadow disabled:opacity-50 transition-colors"
                >
                  ...
                  <div key={leg._id} className="p-4 border rounded-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div className="flex-1">
                      ...
                      {hasAssignedRider && (
                        <div className="mt-2 flex items-center gap-3">
                          <p className="text-sm text-[#550fa8] font-medium">
                      ...
                      {canAssign && (
                        <div className="mt-2 flex items-center gap-2">
                          <button 
                            ...
                            disabled={submitting}
                            className="text-xs font-bold text-[#550fa8] bg-[#f7f3fc] hover:bg-[#f0e7f9] px-3 py-1.5 rounded transition-colors flex items-center gap-1"
                          >
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      {(leg.returnStatus === 'return_completed' || leg.returnStatus === 'returned') && (
                        <span className="flex items-center gap-1 text-[#550fa8] font-bold bg-[#f7f3fc] px-3 py-1 rounded-full text-sm">
