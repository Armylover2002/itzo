    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50">
        <div className="flex items-center gap-3 rounded-2xl border border-slate-100 dark:border-white/5 bg-white dark:bg-card px-4 py-3 shadow-sm transition-colors">
          <Loader2 className="animate-spin text-primary-orange" size={22} />
      ...
      <div className="space-y-4 px-4 pb-2">
        {orders.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <Link
              to={categoriesPath}
              className="rounded-full bg-primary-orange hover:bg-primary-hover active:bg-primary-dark px-7 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors"
            >
              Start Shopping
            </Link>
          </div>
          ...
          orders.map((order) => {
            ...
            return (
              <article
                ...
                className="cursor-pointer rounded-2xl border border-slate-100/80 dark:border-white/5 bg-white dark:bg-card px-4 py-3.5 shadow-[0_8px_24px_rgba(15,23,42,0.06)] transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(15,23,42,0.1)] focus:outline-none focus:ring-2 focus:ring-primary-orange/20"
              >
        ...
        {hasMore && orders.length > 0 && (
          <div className="flex justify-center mt-6 mb-8">
            ...
            >
              {loadingMore && <Loader2 className="animate-spin text-primary-orange" size={16} />}
