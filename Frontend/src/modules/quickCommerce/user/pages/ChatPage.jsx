                    ...
                    <div key={msg.id} className={`flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                        <div className={`max-w-[80%] relative group ${msg.sender === 'user' ? 'items-end' : 'items-start'} flex flex-col`}>
                            <div className={`px-4 py-3 rounded-2xl shadow-sm border text-sm leading-relaxed ${msg.sender === 'user'
                                ? 'bg-primary-orange text-white border-transparent rounded-tr-none'
            ...
            <div className="bg-white p-3 border-t border-slate-100 shrink-0 z-30 safe-area-bottom relative mb-4">
                ...
                <div className="flex items-end gap-2 bg-slate-50 p-2 rounded-[1.5rem] border border-slate-200 focus-within:border-orange-300 focus-within:shadow-[0_0_0_4px_rgba(254,85,2,0.1)] transition-all">
                    <button
                        ...
                        className={`p-2.5 rounded-full hover:text-slate-600 hover:bg-slate-200 transition-colors flex-shrink-0 ${showEmojiPicker ? 'text-primary-orange bg-orange-50' : 'text-slate-400'}`}
                    >
                        <Smile size={22} />
                    </button>
                    ...
                    <button
                        ...
                        className="p-2.5 rounded-full bg-primary-orange hover:bg-primary-hover active:bg-primary-dark text-white transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-md shadow-orange-200 flex-shrink-0"
                    >
