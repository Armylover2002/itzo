...
const STATUS_CONFIG = {
  ...
  APPROVED: { color: 'text-orange-500', bg: 'bg-orange-50', icon: CheckCircle, label: 'Approved' },
  PARTIALLY_APPROVED: { color: 'text-orange-500', bg: 'bg-orange-50', icon: CheckCircle, label: 'Partially Approved' },
  REJECTED: { color: 'text-red-500', bg: 'bg-red-50', icon: XCircle, label: 'Rejected' },
  IN_PROGRESS: { color: 'text-orange-500', bg: 'bg-orange-50', icon: Clock, label: 'In Progress' },
  ...
  REFUND_PENDING: { color: 'text-orange-500', bg: 'bg-orange-50', icon: Clock, label: 'Refund Processing' },
