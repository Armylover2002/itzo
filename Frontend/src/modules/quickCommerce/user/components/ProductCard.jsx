    ...
    >
      <div className={cn(
        ...
        <div className="relative p-2.5">
          {discount > 0 && (
            <span className="absolute left-2.5 top-2.5 z-10 rounded-lg bg-primary-orange px-2 py-1 text-[9px] font-black uppercase tracking-wide text-white">
              {discount}% OFF
            </span>
          )}
        ...
        <div className="flex flex-1 flex-col px-3.5 pb-3.5">
          <div className="mb-1.5 flex items-center gap-1.5 text-[10px] font-bold text-primary-orange">
          ...
          <div className="mt-auto flex flex-wrap items-end justify-between pt-3.5 gap-2">
            ...
            <div className="flex flex-shrink-0">
              {quantity > 0 ? (
                <div className="flex items-center rounded-xl border border-primary-orange bg-white p-0.5 shadow-sm w-[72px] justify-between h-[32px]">
                  <button 
                    onClick={(e) => { e.stopPropagation(); onDecrement(product); }} 
                    className="flex-1 flex items-center justify-center text-primary-orange transition-transform active:scale-90"
                  >
                    <Minus className="h-3.5 w-3.5 stroke-[3.5px]" />
                  </button>
                  <span className="text-[12px] font-black text-primary-orange px-0.5">{quantity}</span>
                  <button 
                ...
                <motion.button
                  ...
                  className="flex items-center justify-center rounded-xl border border-primary-orange bg-white w-[72px] h-[32px] text-[11px] font-black uppercase tracking-wide text-primary-orange shadow-sm transition-all hover:bg-primary-orange hover:text-white active:bg-primary-dark"
                >
                  ADD
                </motion.button>
              )}
