...
export default function ServiceSwitchCards({
  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 gap-3 sm:gap-5 md:gap-8 lg:gap-10 max-w-3xl md:max-w-[1100px] mx-auto">
            ...
            >
              ...
              <div className="flex flex-col justify-between h-full min-w-0 pr-1 z-10">
                ...
                <div>
                  <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <h3 className="text-sm sm:text-base md:text-2xl font-black text-gray-900 dark:text-white tracking-tight leading-none uppercase">
                      {service.title}
                    </h3>
                  </div>
              ...
              <div className="shrink-0 flex items-center justify-center z-10 self-center sm:self-end">
                <img
                  src={service.image}
                  alt={service.alt}
                  className="h-16 sm:h-20 md:h-[140px] w-auto object-contain drop-shadow-sm pointer-events-none group-hover:scale-105 transition-transform duration-300"
                  loading="lazy"
                />
              </div>
