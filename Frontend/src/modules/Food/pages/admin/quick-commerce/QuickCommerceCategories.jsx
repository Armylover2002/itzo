    ...
    <div className="px-4 py-4 lg:px-6">
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div className="flex items-center justify-between gap-3 border-b border-slate-100 px-5 py-4">
          ...
          <Link to="/ecs/quick-commerce/categories/add" className="rounded-xl bg-primary-orange hover:bg-primary-hover active:bg-primary-dark px-3 py-2 text-sm font-bold text-white transition-colors">
            Add Category
          </Link>
        </div>
