...
const colorOptions = [
  ...
  { value: 'text-primary dark:text-[#9359d7]', label: 'Blue', bg: 'bg-[#f0e7f9] dark:bg-[#28074f]/30' },
  { value: 'text-green-600 dark:text-green-400', label: 'Green', bg: 'bg-green-100 dark:bg-green-900/30' },
  { value: 'text-[#550fa8] dark:text-[#9359d7]', label: 'Orange', bg: 'bg-[#f0e7f9] dark:bg-[#28074f]/30' },
  { value: 'text-primary dark:text-[#9359d7]', label: 'Purple', bg: 'bg-[#f0e7f9] dark:bg-[#28074f]/30' },
