                ...
                >
                  ...
                  {plan.durationUnit === 'DAY' ? (
                    ...
                    <Button 
                      ...
                      className={`w-full h-12 rounded-2xl font-bold text-sm tracking-wide transition-all ${(isCurrentPlan || isLocked) ? 'bg-slate-100 text-slate-400' : 'bg-[#0D315B] hover:bg-[#E64D02] text-white shadow-lg shadow-[#0D315B]/20'}`}
                    >
                      {purchasing === plan._id ? (
