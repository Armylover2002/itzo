  ...
  return (
    <div className="relative w-full bg-black py-20 md:py-28 flex flex-col items-center overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-30">
        ...
        <svg className="absolute bottom-0 left-0 w-64 h-64 text-[#FE5502]/20 transform -translate-x-1/2 translate-y-1/2" viewBox="0 0 100 100">
        ...
        <svg className="absolute bottom-0 right-0 w-64 h-64 text-[#FE5502]/20 transform translate-x-1/2 translate-y-1/2" viewBox="0 0 100 100">
          <polygon points="50,0 100,50 50,100 0,50" fill="none" stroke="currentColor" strokeWidth="1"/>
          <polygon points="50,20 80,50 50,80 20,50" fill="none" stroke="currentColor" strokeWidth="1"/>
          <polygon points="50,40 60,50 50,60 40,50" fill="none" stroke="currentColor" strokeWidth="1"/>
        </svg>
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-5xl px-4">
        ...
        <motion.div
          ...
          className="flex items-center justify-center text-[70px] md:text-[140px] font-black tracking-widest bg-gradient-to-b from-[#ffb37a] via-[#FE5502] to-[#8a2c00] bg-clip-text text-transparent leading-none mb-6 drop-shadow-[0_10px_30px_rgba(254,85,2,0.2)]"
        >
          PRO
        </motion.div>
        ...
        <motion.p
          ...
          className="text-[#FE5502] text-xl md:text-[22px] text-center font-medium leading-relaxed mb-12 md:mb-16 max-w-sm"
        >
        ...
        >
          <Star className="w-5 h-5 md:w-6 md:h-6 text-[#FE5502] fill-[#FE5502]" />
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-24 w-full justify-center px-4">
          ...
          >
            <div className="w-20 h-20 rounded-full bg-[#1a0e05] flex items-center justify-center border border-[#FE5502]/30 shadow-[0_0_20px_rgba(254,85,2,0.15)] flex-shrink-0">
            ...
            <div className="flex flex-col justify-center h-full pt-1 md:pt-2">
               ...
               <p className="text-[#FE5502]/80 text-base md:text-[17px] font-medium leading-snug">On eligible nearby orders</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-col justify-center h-full pt-1 md:pt-2">
               ...
               <p className="text-[#FE5502]/80 text-base md:text-[17px] font-medium leading-snug">At partner restaurants</p>
            </div>
          </motion.div>
