...
const profileToForm = (data = {}) => ({
  ...
  medicalLicenseNumber: data.documents?.medicalLicenseNumber || "",
  medicalLicenseExpiry: toDateInputValue(data.documents?.medicalLicenseExpiry),
  medicalLicenseImage: data.documents?.medicalLicenseImage || "",
...
const inputClass =
  "w-full px-3 py-1.5 bg-slate-50/70 border border-slate-200 rounded-lg text-xs font-normal text-slate-900 outline-none focus:bg-white focus:border-red-500 focus:ring-1 focus:ring-red-500/20 transition-all disabled:opacity-70";
