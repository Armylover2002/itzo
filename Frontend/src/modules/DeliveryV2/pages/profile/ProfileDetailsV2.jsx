        ...
        <div className="relative group">
           ...
           <div className="flex items-center justify-center absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 gap-2">
              <button 
                ...
                className="bg-primary text-primary-foreground p-3 rounded-2xl shadow-xl hover:bg-primary/90 transition-all active:scale-95 border-4 border-white flex items-center justify-center"
                title="Take Photo"
              >
