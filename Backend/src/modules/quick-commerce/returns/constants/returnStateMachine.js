...
export const MASTER_TRANSITIONS = Object.freeze({
  [MASTER_STATUS.RETURN_REQUESTED]:    [MASTER_STATUS.UNDER_ADMIN_REVIEW, MASTER_STATUS.APPROVED, MASTER_STATUS.PARTIALLY_APPROVED, MASTER_STATUS.REJECTED, MASTER_STATUS.CANCELLED],
...
export const LEG_TRANSITIONS = Object.freeze({
  [LEG_STATUS.RETURN_REQUESTED]:       [LEG_STATUS.UNDER_REVIEW, LEG_STATUS.RETURN_APPROVED, LEG_STATUS.PARTIALLY_APPROVED, LEG_STATUS.RETURN_REJECTED, LEG_STATUS.CANCELLED],
